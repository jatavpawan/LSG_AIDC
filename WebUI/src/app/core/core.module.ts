...
import { WiresInDataService } from './services/wires/wires-in-data.service';
...
import { CustomerInfoVaultDataService } from "./services/customer-info-vault-data.service";
import {VendorDeliveryDataService} from "./review/vendor-delivery.service";
...
@NgModule({
    ...
    providers: [MenuService, SettingsService, AchDataService,
        ...
        UserSettingsDataService, AchMediatorService, DraftsDataService, InternalTransferDataService, ProcessingDatesDataService, InternalTransferMediatorService, WiresInDataService, CustomerInfoVaultDataService, VendorDeliveryDataService]
})
