...
import { DataTableModule, MultiSelectModule, SliderModule, DropdownModule, ChipsModule, DialogModule, AutoCompleteModule } from 'primeng/primeng';
...
@NgModule(({
    ...
    imports: [FormsModule, CommonModule, MyDatePickerModule, DataTableModule,
        ...
        CurrencyMaskModule,
        DropdownModule,
        ChipsModule, DialogModule, AutoCompleteModule, BootstrapModalModule, TabViewModule, AccordionModule],
    exports: [
        FormsModule,
        CommonModule,
        SchedulerComponent,
